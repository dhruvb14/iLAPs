...
<#
    ...
    .DESCRIPTION
    This script reset all locally created admin user accounts.
...
<Task version="1.4" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions Context="Author">
    <Exec>
      ...
      <Arguments>-ExecutionPolicy Bypass -File "C:\Windows\System32\Intune Management\iLAPS\Reset-LocalAdministratorPassword_V2.0.ps1"</Arguments>
    </Exec>
  </Actions>
</Task>
...
# Check if the Old schedule task exists. If so, remove it.
try {
...
Foreach ($LocalAdministrator in $LocalAdministrators) {
    ...
    # Generate password
    $Password = (New-Password -MinPasswordLength 14 -MaxPasswordLength 14);
